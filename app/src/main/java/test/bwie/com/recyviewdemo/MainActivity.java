package test.bwie.com.recyviewdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mRecyclerView == null) {
            ...
            mRecyclerView = (AnimRFRecyclerView) findViewById(R.id.recy);
            // 头部
            headerView = LayoutInflater.from(MainActivity.this).inflate(R.layout.hander, null);
            // 脚部
            footerView = LayoutInflater.from(MainActivity.this).inflate(R.layout.footer, null);

            // 使用重写后的线性布局管理器
            AnimRFLinearLayoutManager manager = new AnimRFLinearLayoutManager(MainActivity.this);
            mRecyclerView.setLayoutManager(manager);
            mRecyclerView.addItemDecoration(new DividerItemDecoration(MainActivity.this, manager.getOrientation(), true));
...
//            mRecyclerView.addFootView(footerView);
            // 设置刷新动画的颜色
            mRecyclerView.setColor(Color.YELLOW, Color.GREEN);
